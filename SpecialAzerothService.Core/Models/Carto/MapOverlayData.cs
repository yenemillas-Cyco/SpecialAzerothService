...
/// <summary>Positions calibrées pour Assets/WowMap.png (0–1).</summary>
public static class MapOverlayData
{
    ...
    [
        ...
        new() { NameEN = "Silithus", NameFR = "Silithus", X = 0.135, Y = 0.530, LevelMin = 55, LevelMax = 60 },
    ...
    [
        new() { NameEN = "Rut'theran Village", NameFR = "Village de Rut'theran", Faction = Faction.Alliance, X = 0.080, Y = 0.075 },
        new() { NameEN = "Auberdine", NameFR = "Auberdine", Faction = Faction.Alliance, X = 0.095, Y = 0.170 },
        new() { NameEN = "Astranaar", NameFR = "Astranaar", Faction = Faction.Alliance, X = 0.155, Y = 0.245 },
        new() { NameEN = "Stonetalon Peak", NameFR = "Pic des Serres-Rocheuses", Faction = Faction.Alliance, X = 0.105, Y = 0.280 },
        new() { NameEN = "Nijel's Point", NameFR = "Pointe de Nijel", Faction = Faction.Alliance, X = 0.080, Y = 0.365 },
        new() { NameEN = "Thalanaar", NameFR = "Thalanaar", Faction = Faction.Alliance, X = 0.200, Y = 0.440 },
        new() { NameEN = "Feathermoon Stronghold", NameFR = "Bastion de Pennelune", Faction = Faction.Alliance, X = 0.060, Y = 0.500 },
        new() { NameEN = "Theramore Isle", NameFR = "Île de Theramore", Faction = Faction.Alliance, X = 0.310, Y = 0.410 },
        new() { NameEN = "Gadgetzan", NameFR = "Gadgetzan", Faction = Faction.Neutral, X = 0.245, Y = 0.560 },
        new() { NameEN = "Marshal's Refuge", NameFR = "Refuge du Maréchal", Faction = Faction.Neutral, X = 0.175, Y = 0.545 },
        new() { NameEN = "Cenarion Hold", NameFR = "Fort Cénarien", Faction = Faction.Neutral, X = 0.135, Y = 0.530 },
        new() { NameEN = "Everlook", NameFR = "Long-Guet", Faction = Faction.Neutral, X = 0.260, Y = 0.095 },
        new() { NameEN = "Nighthaven", NameFR = "Havrenuit", Faction = Faction.Neutral, X = 0.195, Y = 0.105 },
        new() { NameEN = "Orgrimmar", NameFR = "Orgrimmar", Faction = Faction.Horde, X = 0.305, Y = 0.255 },
        new() { NameEN = "Crossroads", NameFR = "La Croisée", Faction = Faction.Horde, X = 0.235, Y = 0.320 },
        new() { NameEN = "Thunder Bluff", NameFR = "Les Pitons du Tonnerre", Faction = Faction.Horde, X = 0.155, Y = 0.385 },
        new() { NameEN = "Camp Taurajo", NameFR = "Camp Taurajo", Faction = Faction.Horde, X = 0.205, Y = 0.395 },
        new() { NameEN = "Sun Rock Retreat", NameFR = "Retraite de Roche-Soleil", Faction = Faction.Horde, X = 0.120, Y = 0.300 },
        new() { NameEN = "Splintertree Post", NameFR = "Poste de Bois-Fendu", Faction = Faction.Horde, X = 0.200, Y = 0.240 },
        new() { NameEN = "Zoram'gar Outpost", NameFR = "Avant-poste de Zoram'gar", Faction = Faction.Horde, X = 0.085, Y = 0.235 },
        new() { NameEN = "Freewind Post", NameFR = "Poste de Librevent", Faction = Faction.Horde, X = 0.215, Y = 0.460 },
        new() { NameEN = "Shadowprey Village", NameFR = "Village de Proie-de-l'Ombre", Faction = Faction.Horde, X = 0.060, Y = 0.420 },
        new() { NameEN = "Camp Mojache", NameFR = "Camp Mojache", Faction = Faction.Horde, X = 0.100, Y = 0.510 },
        new() { NameEN = "Brackenwall Village", NameFR = "Village de Branchecombe", Faction = Faction.Horde, X = 0.270, Y = 0.385 },
        new() { NameEN = "Valormok", NameFR = "Valormok", Faction = Faction.Horde, X = 0.280, Y = 0.200 },
        new() { NameEN = "Ironforge", NameFR = "Forgefer", Faction = Faction.Alliance, X = 0.685, Y = 0.315 },
        new() { NameEN = "Stormwind", NameFR = "Hurlevent", Faction = Faction.Alliance, X = 0.650, Y = 0.465 },
        new() { NameEN = "Menethil Harbor", NameFR = "Port de Menethil", Faction = Faction.Alliance, X = 0.710, Y = 0.260 },
        new() { NameEN = "Thelsamar", NameFR = "Thelsamar", Faction = Faction.Alliance, X = 0.755, Y = 0.310 },
        new() { NameEN = "Refuge Pointe", NameFR = "Halte de Refuge", Faction = Faction.Alliance, X = 0.750, Y = 0.205 },
        new() { NameEN = "Southshore", NameFR = "Austrivage", Faction = Faction.Alliance, X = 0.680, Y = 0.200 },
        new() { NameEN = "Aerie Peak", NameFR = "Pic de l'Aigle", Faction = Faction.Alliance, X = 0.775, Y = 0.160 },
        new() { NameEN = "Chillwind Camp", NameFR = "Camp du Noroît", Faction = Faction.Alliance, X = 0.660, Y = 0.110 },
        new() { NameEN = "Light's Hope Chapel", NameFR = "Chapelle de l'Espoir de Lumière", Faction = Faction.Neutral, X = 0.765, Y = 0.078 },
        new() { NameEN = "Sentinel Hill", NameFR = "Colline des Sentinelles", Faction = Faction.Alliance, X = 0.630, Y = 0.520 },
        new() { NameEN = "Lakeshire", NameFR = "Comté-du-Lac", Faction = Faction.Alliance, X = 0.765, Y = 0.445 },
        new() { NameEN = "Darkshire", NameFR = "Sombre-Comté", Faction = Faction.Alliance, X = 0.720, Y = 0.510 },
        new() { NameEN = "Nethergarde Keep", NameFR = "Rempart du Néant", Faction = Faction.Alliance, X = 0.820, Y = 0.535 },
        new() { NameEN = "Booty Bay", NameFR = "Baie-du-Butin", Faction = Faction.Neutral, X = 0.680, Y = 0.700 },
        new() { NameEN = "Rebel Camp", NameFR = "Camp des Rebelles", Faction = Faction.Alliance, X = 0.670, Y = 0.580 },
        new() { NameEN = "Thorium Point", NameFR = "Pointe du Thorium", Faction = Faction.Neutral, X = 0.700, Y = 0.365 },
        new() { NameEN = "Morgan's Vigil", NameFR = "Veille de Morgan", Faction = Faction.Alliance, X = 0.715, Y = 0.410 },
        new() { NameEN = "Undercity", NameFR = "Fossoyeuse", Faction = Faction.Horde, X = 0.645, Y = 0.098 },
        new() { NameEN = "The Sepulcher", NameFR = "Le Sépulcre", Faction = Faction.Horde, X = 0.600, Y = 0.140 },
        new() { NameEN = "Tarren Mill", NameFR = "Moulin-de-Tarren", Faction = Faction.Horde, X = 0.670, Y = 0.190 },
        new() { NameEN = "Hammerfall", NameFR = "Chute-du-Marteau", Faction = Faction.Horde, X = 0.770, Y = 0.210 },
        new() { NameEN = "Revantusk Village", NameFR = "Village des Vengebroches", Faction = Faction.Horde, X = 0.800, Y = 0.165 },
        new() { NameEN = "Kargath", NameFR = "Kargath", Faction = Faction.Horde, X = 0.785, Y = 0.370 },
        new() { NameEN = "Flame Crest", NameFR = "Crête-de-Flamme", Faction = Faction.Horde, X = 0.705, Y = 0.395 },
        new() { NameEN = "Stonard", NameFR = "Pierrêche", Faction = Faction.Horde, X = 0.835, Y = 0.475 },
        new() { NameEN = "Grom'gol", NameFR = "Grom'gol", Faction = Faction.Horde, X = 0.660, Y = 0.600 },
    ];
